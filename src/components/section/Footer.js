        ...
        <div className="row px-xl-5 pt-5">
            ...
            <div className="col-lg-8 col-md-12">
                <div className="row">
                    ...
                    <QuickLinks label = "Quick Shop"/>
                    <QuickLinks label = "My Account"/>
...
export function QuickLinks(props){
    return (
        <div className="col-md-4 mb-5">
                        <h5 className="text-secondary text-uppercase mb-4">{props.label}</h5>
                        <div className="d-flex flex-column justify-content-start">
                            ...
                            <Link className="text-secondary" to="contact-us"> <i className="fa fa-angle-right mr-2"></i>Contact Us</Link>
                        </div>
                    </div>
    )
}